/*
Statement: Harmonic series is a special type of infinite series in math.
Write a program that given the number n, find the sum with the precision of 3 decimal 
digits.

Solution: Declare a counter i, initialize it to 1 as in the formula it is stated that i starts from 1. 
